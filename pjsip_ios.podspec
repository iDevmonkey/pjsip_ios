Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/iDevmonkey/pjsip_ios.git", :tag => "#{s.version}" }
  s.platform     = :ios, '7.0'
  s.description  = <<-DESC
...
LICENSE
  ...
  s.public_header_files = 'build/pjproject/src/pjsip/include/**',
                          ...
                          'build/libyuv/include/**',
                          'build/libyuv/include/libyuv/**'
  ...
  header_search_paths   = '"$(PODS_ROOT)/pjsip/build/pjproject/src/pjsip/include"',
                          ...
                          '"$(PODS_ROOT)/libyuv/build/libyuv/include"',
                          '"$(PODS_ROOT)/libyuv/build/libyuv/include/libyuv"'
